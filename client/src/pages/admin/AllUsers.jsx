      ...
      <div className="w-full flex h-screen ">
        <div className="w-full rounded-lg p-2">
          ...
          <div>
            <input
              type="text"
              className="my-3 p-1 rounded-lg border min-w-72 max-w-96"
          ...
          {loading ? (
          Array.from({ length: allUser.length || 3 }).map((_, i) => (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 justify-center items-center p-[5px]">
                    <button
                      disabled={loading}
                      className="p-2 text-red-600 hover:cursor-pointer hover:scale-125 disabled:opacity-80"
                      onClick={() => {
